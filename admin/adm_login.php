...
<head>
  ...
  <title>Login Administration | Yuk-Futsal</title>
        ...
        <section class="login_content">
          <form action="" method="post">
            ...
            <div class="separator">
              ...
              <div>
                <h1><img src="../assets/images/Pfutsal.png" style="width:25px; height:25px;"> Yuk-<font color="#ecb213">Futsal</font>
                </h1>
                <p>Yuk Futsal By Yuk Futsal-Team</p>
                <p>©2023 All Rights Reserved</p>
                <p>Repost by <a href="https://instagram.com/achyar_aesthetic" title="instagram.com" target="_blank">instagram.com</a></p>
              </div>
            </div>
          </form>
          <?php
